    ...
    <>
      ...
      <Flex direction="column" w="100%" bgColor="white" borderRadius="4">
        ...
        {isLoading ? (
          ...
          <>
            <SymptomAddModal isOpen={isOpenAddModal} onClose={onCloseAddModal} refetchList={refetch} />
            ...
            <Box mx={{ base: 4, md: 8 }} overflowX="auto">
              {data?.totalSymptoms === 0 ? (
                ...
                <>
                  ...
                  {/* Paginação */}
                  <Box w="100%" mt="3" mb="5">
                    <Pagination currentPage={page} totalRegisters={data?.totalSymptoms} onPageChange={setPage} />
                  </Box>
                </>
              )}
            </Box>
